...
- **Link Shortcut & Link Grid**: Quick access to your favourite services
- **Weather Widget**: Real-time weather data (no API key required)
- **System Stats**: Monitor server health and performance
- **RSS Feeds**: Stay updated with your favourite sources
- **Markdown Notes**: Rich text notes directly on your dashboard
- **CVE Tracker**: Track recent security vulnerabilities
- **API Widget**: Display custom HTML/CSS pushed from external scripts
