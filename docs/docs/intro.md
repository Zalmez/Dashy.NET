...
2. Navigate to the AppHost project folder: ``cd .\dashy3.AppHost\``
3. Run the following command: ``dotnet run --project dashy3.AppHost.csproj --output-path manifest.json --publisher manifest`` This builds the manifest AZD will basing the deployment of.
